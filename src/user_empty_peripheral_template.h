...
// Advertising data update timer interval (in 10ms units, 1000 = 10 seconds)
#define APP_ADV_DATA_UPDATE_TO      (1000)

// Manufacturer Specific Data Company ID (Dialog Semiconductor)
#define APP_AD_MSD_COMPANY_ID       (0x00D2)
#define APP_AD_MSD_COMPANY_ID_LEN   (2)

// Temperature data format
#define TEMPERATURE_DATA            (9)     // Max bytes for temperature string "XX.XXXX\0"
#define APP_AD_MSD_DATA_LEN         (TEMPERATURE_DATA)
#define SNPRINT_FORMAT              "%d.%04d"
...
/**
 ****************************************************************************************
 * @brief Advertising start function with temperature data.
 ****************************************************************************************
*/
...
/**
 ****************************************************************************************
 * @brief Non-connected advertising completion function.
